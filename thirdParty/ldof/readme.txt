Matlab Mex-Function for running Large Displacement Optical Flow as
presented in IEEE PAMI 2011
...
Call "doc mex_LDOF" for a description of the arguments.

See demoLDOF for an example how to run the code.
